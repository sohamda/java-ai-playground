...
public class FunctionInvocationTests {
    ...
    void validateFunctionInvocation(String chatId, String userMessage, int iTermsAndConditions, int iBookingDetails,
        ...
        // then
        verify(contentRetriever, times(iTermsAndConditions)).getTermsAndConditions(anyString());
    ...
    private static Stream<Arguments> functionInvocationTestParams() {
        return Stream.of(
                ...
                Arguments.of("first", "I am Robert Taylor and my booking num is 105, can you get me my booking details", 0, 1, 0, 0),
                // cancellation test, but first the kernel will get booking details and terms and policies
                Arguments.of("second", "I am Robert Taylor and my booking num is 105, can you cancel my booking", 1, 1, 0, 0),
                ...
                Arguments.of("third", "I am Sarah Williams and my booking num is 104, can you update my booking for 2024-05-16 from Amsterdam to Paris", 1, 1, 0, 0),
